...
const HeroArcades = () => {
  ...
  return (
    <section
      className={`hero-arcades-wrapper ${isUnlocked ? "unlocked" : "locked"}`}
    >
            ...
            <div className="monitor-frame">
              <div className="screen-content">
                ...
                <div className="main-display">
                  <h1 className="glitch-title" data-text="LOCKED">
                    LOCKED
                  </h1>
                  <div className="code-dots">
                    {CHEAT_CODE.map((_, i) => (
                      <span
                        key={i}
                        className={`dot ${typedCode.length > i ? "filled" : ""}`}
                      />
                    ))}
                  </div>
                  {feedback && (
          ...
          >
            ...
            <div className="content-inner">
              ...
              <h1 className="hero-title">
                BIENVENUE AUX <span className="accent">ARCADES</span>
              </h1>
